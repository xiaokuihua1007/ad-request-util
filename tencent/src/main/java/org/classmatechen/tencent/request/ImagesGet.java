...
import com.tencent.ads.model.v3.ImagesGetListStruct;
 ...
 */
public class ImagesGet extends TxRequest<ImagesGet.Param, List<ImagesGetListStruct>> {
    ...
    @Override
    protected Response<List<ImagesGetListStruct>> todo(TencentAds client, Param param)
            throws ApiException, TencentAdsResponseException {

        ImagesGetResponseData response = client.images().imagesGet(
            param.getAccountId(),
        ...
        return Parser.page(response, ImagesGetListStruct.class);
    }   
}
